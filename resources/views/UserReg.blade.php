   ...
   @if(session::has('sucess'))
    <div class="w-96 h-full left-[500px] top-[80px] absolute">
        ...
        <div class="relative mb-6  ml-8 w-full">
            ...
            <input type="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@email.com">
        </div>
        ...
        <div class="relative mb-6 ml-8  w-full">
            ...
            <input type="password" name="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="********">
        </div>
        <!-- Here start the component -->
        ...
        <div class="relative mb-6  ml-8 w-full">
            ...
            <input type="password" name="rpassword" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="********">
        </div>
        <!-- Here Ends the component -->

        <!-- Here start the component -->
        <label class="block mb-1.5 ml-6 mt-4 text-4xl font-['Krona One'] font-medium text-white dark:text-white scale-95">Phone Number</label>
        <div class="relative mb-6  ml-8 w-full">
            <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
            ...
            <input type="number" name="phone_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-white dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Phone Number">
        </div>
        <!-- Here Ends the component -->

        <!-- Here start the component -->
        <div class="relative mb-6 mt-12  ml-12 justify-center">
            <button type="submit" class="text-white bg-amber-500 font-medium rounded-3xl  hover:bg-amber-300 text-5xl font-KronaOne w-96 h-14">Create Account</button>
